...
class WebScraperStack(Stack):
    ...
    def create_second_hand_scrapers(self):
        ...
        vinted_scraper_function = self.create_vinted_scraper_function(
            chrome_driver_lambda_layer,
            article_topic.topic_arn,
        ...
        daily_event_rule.add_target(LambdaFunction(vinted_scraper_function))
        ...
        self.grant_second_hand_permissions(
            ...
            vinted_scraper_function=vinted_scraper_function,
    ...
    def create_html_bucket(self) -> s3.Bucket:
        return s3.Bucket(
            self,
            "HtmlStorageBucket",
            bucket_name="serverless-scraper-html-emails-new",
    ...
    def create_vinted_scraper_function(
        self, chrome_driver_layer, topic_arn, table_name, bucket_name, queue_url
    ) -> PythonFunction:
        return PythonFunction(
            self,
    ...
    def grant_second_hand_permissions(
        ...
        article_topic.grant_publish(vinted_scraper_function)

        sender_email_identity.grant_send_email(vinted_scraper_function)
